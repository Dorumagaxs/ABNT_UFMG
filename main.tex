...
\newcommand{\texto}{\input{./textual/texto.tex}}

% Importa os arquivos contendo os elementos pós-textuais
\newcommand{\glossario}{\input{./postextual/glossario.tex}}
\newcommand{\apendices}{\input{./postextual/apendices.tex}}
\newcommand{\anexos}{\input{./postextual/anexos.tex}}
\newcommand{\indice}{\input{./postextual/indice.tex}}

% Importa as referências manualmente escritas
\newcommand{\referenciasmanuais}{
	\section*{REFERÊNCIAS}
...
% Define a formatação das seções para elementos pós-textuais
\newcommand{\postextualsection}[1]{%
	\setcounter{section}{0}
	\renewcommand{\thesection}{\Alph{section}}
	\renewcommand{\sectionbreak}{\clearpage}
	\titleformat{\section}{\centering\normalfont\bfseries}{{#1} {\thesection} - }{\spacecharacterlength}{}
	\titlecontents{section}[1em]{}{\bfseries{#1} \contentslabel{0em}\hspace{.5em} - }{}{\bfseries\dotfill\contentspage}[\addvspace{1em}]
}
...
%	\glossario				% opcional
	\postextualsection{APÊNDICE}
	\apendices
	\postextualsection{ANEXO}
	\anexos					% opcional
%	\indice					% opcional
\end{document}
